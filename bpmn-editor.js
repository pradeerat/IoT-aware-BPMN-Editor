    ...
    var bpmnEditor = (function (SVG, $, vkbeautify) {
        var constants = {
            ...
            widgetsInfo = [
                ...
                { type: "activity", id: 2, name: "subProcess", src: "bpmn pic/subprocess.png" },
	             { type: "activity", id: 3, name: "sensor", src: "bpmn pic/sensor_task1.png" },
                { type: "activity", id: 4, name: "actuator", src: "bpmn pic/actuator_task.png" },
                { type: "activity", id: 5, name: "reader", src: "bpmn pic/read_task.png" },
                ...
                { type: "data", id: 3, name: "DataObject", src: "bpmn pic/data object.png" },

                { type: "data", id: 4, name: "Database", src: "bpmn pic/database.png" },
                { type: "data", id: 5, name: "SmartObject", src: "bpmn pic/smartobject6.png" },
                { type: "data", id: 6, name: "InputEvent", src: "bpmn pic/inputevent.png" },
                { type: "data", id: 7, name: "OutputEvent", src: "bpmn pic/outputevent.png" },
                { type: "data", id: 8, name: "PhysicalEntity", src: "bpmn pic/physicalentity.png" }
            ];
